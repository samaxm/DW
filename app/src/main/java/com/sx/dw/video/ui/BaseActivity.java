...
import com.sx.dw.video.model.EngineConfig;
import com.sx.dw.video.model.MyEngineEventHandler;
...
public abstract class BaseActivity extends AppCompatActivity {
    ...
    public boolean checkSelfPermission(String permission, int requestCode) {
        ...
        if (Manifest.permission.CAMERA.equals(permission)) {
            ((DWApplication) getApplication()).initWorkerThread();
        }
        return true;
    }

    protected RtcEngine rtcEngine() {
        return ((DWApplication) getApplication()).getWorkerThread().getRtcEngine();
    }

    protected final WorkerThread worker() {
        return ((DWApplication) getApplication()).getWorkerThread();
    }

    protected final EngineConfig config() {
        return ((DWApplication) getApplication()).getWorkerThread().getEngineConfig();
    }

    protected final MyEngineEventHandler event() {
        return ((DWApplication) getApplication()).getWorkerThread().eventHandler();
    }
    ...
    protected CurrentUserSettings vSettings() {
        return DWApplication.mVideoSettings;
    }
